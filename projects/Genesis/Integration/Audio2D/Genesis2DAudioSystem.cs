...
namespace Genesis.Integration.Audio2D;

public sealed class Genesis2DAudioSystem : ISystem, IWorldSystem
{
    #region 字段
    ...
    public void Initialize()
    {
        ...
        _initialized = true;
        Console.WriteLine("[Genesis] 2D 音频系统初始化完成");
    }
    ...
    private void SyncListenerFromWorld()
    {
        ...
        foreach (var entityId in entities)
        {
            ...
            listener.Position = new Vector3(transform.PosX, transform.PosY, 0);
